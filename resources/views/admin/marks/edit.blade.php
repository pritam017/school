...
<div class="container">
    <div class="card-header">
        <h3>Manage Marks Edit </h3>
    </div>

        <h6>Search Criteria</h6>
        <form method="POST" action="{{ route('marksEntry.update') }}" id="myForm">
            @csrf
            <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <div class="col-md-1" style="padding-top: 33px;">
                      <a id="searchmarkedit" class="btn btn-info btn-sm"><i class="fa fa-search"></i></a>
                  </div>
            </div>
...
@push('js')
<script>
    $(document).on('click','#searchmarkedit', function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function( key,v){
                    ...
                    '<td><input type="text" required class="form-control form-control-sm" name="marks[]" value="'+v.marks+'"></td>'+
                    '</tr>';
                });
