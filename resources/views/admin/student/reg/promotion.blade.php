...
<div class="container">
    <div class="card-header">
        <h3>Promotion Student <a href="{{ route('studentRegistration.index') }}" class="btn btn-primary btn-sm float-right"><i class="fa fa-plus"></i> Student List</a></h3>
    </div>
    <form action="{{ route('regStudent.promotion.store', $editData->student_id) }}" method="POST" enctype="multipart/form-data">
        @csrf
